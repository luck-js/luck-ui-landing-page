...
export type Morph =
  ...
  | UpdateHashtagPayload
  | DeleteHashtagPayload
  | HashtagConnection
  | HashtagAggregator
  | HashtagGroupBy
  | HashtagConnectionName
  | HashtagConnection_Id
  | HashtagConnectionId
  | HashtagConnectionCreatedAt
  | HashtagConnectionUpdatedAt
  | Post
  | CreatePostPayload
  | UpdatePostPayload
  | DeletePostPayload
  ...
  | PostConnectionSlug
  | PostConnectionIsDraft
  | PostConnectionCover
  | PostConnectionCoverPlaceholder
  | PostConnectionWideCover
  | PostConnectionWideCoverPlaceholder
