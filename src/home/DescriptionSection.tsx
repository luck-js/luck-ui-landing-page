...
import { Box, Canon, MediumText } from '../components';
...
const DescriptionSection = () => {
  return (
    <Container>
      <Header>
        Aplikacja powstała z myślą o tym, by ułatwić
        Ci zorganizowanie losowania w gronie Twoich znajomych
        <Separator />
      </Header>
      <Text>
